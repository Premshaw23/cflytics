...
const RatingComparisonGraph = dynamic(() => import("@/components/compare/RatingComparisonGraph").then(mod => mod.RatingComparisonGraph), {
    loading: () => <SkeletonLoader className="h-[300px] w-full" />,
    ssr: false
});

const TagComparison = dynamic(() => import("@/components/compare/TagComparison").then(mod => mod.TagComparison), {
    loading: () => <SkeletonLoader className="h-[300px] w-full" />,
    ssr: false
});
