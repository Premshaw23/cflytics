...
export function Sidebar() {
    ...
    return (
        <motion.nav
            ...
            className="hidden lg:flex flex-col h-screen border-r border-white/5 bg-zinc-950 z-50 shrink-0 relative overflow-hidden"
        >
            {/* Header / Logo Area */}
            <div className="h-auto py-4 flex items-center px-6 shrink-0">
                <Link href="/" className="flex items-center gap-4 group">
                    <div className="w-10 h-10 bg-white rounded-2xl flex items-center justify-center shrink-0 shadow-2xl shadow-white/10 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 ease-out">
                        <Image
                            src="/logo.png"
                            alt="Codey Logo"
                            width={32}
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {isCollapsed && (
                                <div className="fixed left-[90px] px-3 py-2 bg-zinc-900 border border-white/10 rounded-lg text-white text-[10px] font-black uppercase tracking-widest opacity-0 pointer-events-none group-hover:opacity-100 transition-all duration-200 shadow-2xl z-[100] whitespace-nowrap ml-[-10px] group-hover:ml-0">
                                    {item.title}
            ...
            {/* Bottom Actions */}
            <div className="p-4 border-t border-white/5 space-y-1.5 shrink-0 bg-zinc-950">
                <Link
                    href="/settings"
                    className={cn(
                ...
                <button
                    ...
                    className="flex items-center w-full px-3 py-3 rounded-xl text-zinc-500 hover:bg-zinc-900 hover:text-white transition-all group"
                >
                    <div className="flex items-center justify-center w-6 h-6 shrink-0">
