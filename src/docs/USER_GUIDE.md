...
The **Analytics** page provides deep insights into your performance:
- **Peak Difficulty**: The highest rated problem you've ever solved.
- **Time of Day solve patterns**: Understand when you are most productive.
- **Advanced Insights**: Detects your weak topics (e.g., "Dynamic Programming" or "Greedy") and suggests a practice strategy.

## 🧩 Problem Explorer

Browse through 8,000+ problems with ease:
- **Display Mode**: Switch between **Table** (compact) and **Cards** (visual) views in Settings or directly on the Problems page.
- **Filtering**: Filter by multiple tags, rating range, and search by name/ID.
- **Notes & Bookmarks**: Add private notes to problems you're struggling with and bookmark those you want to revisit.
...
- **Compare Mode**: Enter any two handles to see their rating history side-by-side on a unified chart.
- **Global Search**: Use the search bar in the header to quickly peek at any user's profile.
